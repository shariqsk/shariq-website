    ...
    <div className="relative min-h-screen px-4 pt-24 sm:pt-28 pb-8 overflow-hidden">
      <div className="w-full max-w-4xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="bg-black/60 backdrop-blur-sm border border-red-500/30 rounded-lg p-4 sm:p-5 md:p-6 mb-4 sm:mb-5 md:mb-6 relative overflow-hidden"
        >
          {/* Terminal Header */}
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              <span className="text-red-400 text-xs font-mono">contact_details.sh</span>
            </div>
            ...
            <div className="ml-4 space-y-2 sm:space-y-3 text-xs sm:text-sm">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <Mail className="w-6 h-6 sm:w-7 sm:h-7 text-red-400" />
                  <span className="text-red-300 font-semibold">Email:</span>
                  <span className="text-white">contact@shariqsafdarkhan.com</span>
                </div>
                                 <div className="flex items-center gap-3">
                   <User className="w-6 h-6 sm:w-7 sm:h-7 text-red-400" />
                   <span className="text-red-300 font-semibold">Location:</span>
          ...
          <div className="absolute top-2 sm:top-3 md:top-4 right-2 sm:right-3 md:right-4">
            <div className="bg-red-500/20 border border-red-500/40 rounded-md px-1.5 sm:px-2 py-0.5 sm:py-1">
              <div className="flex items-center gap-1">
                <Mail className="w-2 h-2 sm:w-3 sm:h-3 text-red-400" />
            ...
            <div className="flex justify-center gap-5 sm:gap-6">
              {[
                ...
                <motion.a
                  ...
                  className="w-14 h-14 sm:w-16 sm:h-16 rounded-md bg-black/30 hover:bg-blue-500/30 border border-blue-500/30 hover:border-blue-500/60 flex items-center justify-center text-blue-400 hover:text-blue-300 transition-all duration-300 shadow-lg hover:shadow-blue-500/25 backdrop-blur-sm hover:scale-110 hover:-translate-y-1"
                  title={social.label}
            ...
            <div className="space-y-3 sm:space-y-4 font-mono">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center">
                <Button
                  as={Link}
                  href="/about"
                  className="bg-gradient-to-r from-emerald-600 to-cyan-600 text-white px-5 sm:px-6 md:px-7 py-3 sm:py-4 rounded-md transition-all duration-300 font-semibold shadow-lg hover:shadow-emerald-500/25 transform hover:scale-105 flex items-center justify-center gap-3 text-sm sm:text-base font-mono border border-emerald-500/30"
                >
                ...
                <Button
                  as={Link}
                  href="/projects"
                  className="bg-black/30 hover:bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 px-5 sm:px-6 md:px-7 py-3 sm:py-4 rounded-md transition-all duration-300 font-semibold shadow-lg backdrop-blur-sm transform hover:scale-105 flex items-center justify-center gap-3 text-sm sm:text-base font-mono"
                >
