...
const PROJECTS: Entry[] = [
  ...
  {
    name: 'Pineforge',
    role: 'Trading strategies from plain English',
    meta: 'Desktop',
    mono: 'PF',
    href: 'https://pineforge-two.vercel.app',
    stack: ['Desktop app', 'Pine Script', 'TradingView'],
    points: [
      'Describe a strategy in a sentence and it writes valid Pine Script v5, then drives a real TradingView session to compile and run it through the Strategy Tester.',
      'Metrics and chart snapshots are saved locally so every idea can be compared against the last, and finished strategies can be published to a shared marketplace.',
      'Ships as a free macOS and Windows download with no account needed to try it.',
    ],
  },
  {
    name: 'ResuSense',
    ...
    stack: ['JavaScript', 'LaTeX', 'pdflatex'],
    points: [
