...
export const metadata: Metadata = {
  title: 'Projects',
  description: 'Explore Shariq Khan\'s projects - Full-Stack Developer and Computer Security Student. View web applications, computer security projects, and software development work.',
  keywords: [
    ...
    'Shariq Khan Computer Security Projects',
