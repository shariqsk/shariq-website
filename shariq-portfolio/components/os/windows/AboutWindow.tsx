    ...
    <div className="os-pane" style={{ overflowY: 'auto' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ color: '#444', fontSize: 11 }}>Computer Security Student &amp; Full-Stack Developer</div>
      ...
      <div className="w95-groupbox">
        ...
        <p style={{ fontSize: 11, lineHeight: 1.7, color: '#000' }}>
          I&apos;m a 20-year-old Computer Security student at York University building secure,
